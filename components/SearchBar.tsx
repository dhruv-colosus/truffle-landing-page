...
export default function SearchBar() {
    ...
    async function handleSearch(e: React.FormEvent<HTMLFormElement>) {
        ...
        router.push(`${redirectURL}/search?query=${inputValue.trim()}`)
    }
    return (
        <form onSubmit={handleSearch} className="flex gap-2 w-full max-w-xl">
            ...
            <Button type="submit" variant="teal" className="font-bold h-[95%]"><MagnifyingGlassIcon size={40} stroke="black" strokeWidth={18} /> Search</Button>
        </form>
    );
}
